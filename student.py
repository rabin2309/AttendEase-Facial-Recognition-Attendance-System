...
class Student:
    def __init__(self, root):
        ...
        self.root.configure(bg="#f0f0f0")  # Optional: Set background color or style
        ...
        title_lbl=Label(self.root,text="S T U D E N T  M A N A G E M E N T  S Y S T E M",font=("georgia",35,"bold"),bg="#f0f0f0", fg="#4a4a4a")
        ...
        Left_frame.place(x=0, y=10, width=760,height=700)
        ...
        semester_combo["values"]=("Select Semester","First Semester","Second Semester","Third Semester","Fourth Semester","Fifth Semester","Sixth Semester","Seventh Semester","Eightth Semester")
        ...
        class_Student_frame.place(x=5, y=220, width=750,height=400)
        ...
        btn_frame.place(x=0, y=225, width=750, height=300)
        ...
        Right_frame.place(x=780, y=10, width=760,height=700)
      ...
      #Search Frame
        ...
        Search_frame.place(x=5, y=135, width=675,height=200)
        ...
        table_frame.place(x=5, y=210, width=670,height=430)
    ...
    def fetch_data(self):
        try:
            ...
            my_cursor = conn.cursor()
            my_cursor.execute("SELECT * FROM student WHERE student_id")
