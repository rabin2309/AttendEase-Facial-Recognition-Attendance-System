...
class Attendance:
    def __init__(self, root):
        ...
        lbl.place(x=0, y=30, width=500, height=130)
        ...
        lbl.place(x=500, y=30, width=500, height=130)
        ...
        lbl.place(x=1000, y=30, width=600, height=130)

       

        # Title
        title_lbl = Label(self.root,text="A T T E N D A N C E   M A N A G E M E N T   S Y S T E M", font=("georgia", 35, "bold"), bg="#f0f0f0", fg="#4a4a4a")
        title_lbl.place(x=0, y=0, width=1530, height=45)

        # Main Frame
        main_frame = Frame(self.root,bd=2, bg="white")
        main_frame.place(x=20, y=200, width=1485, height=570)
        ...
        back_btn.place(x=0, y=0, width=110, height=50)  # Adjusted position and size for better alignment
