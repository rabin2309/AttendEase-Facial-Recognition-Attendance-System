...
class Face_Recognition:
    ...
    def mark_attendance(self,i,r,n,d):
        ...
        if not os.path.isfile("attendance_report/Student_attendance_list.csv"):
            with open("attendance_report/Student_attendance_list.csv", "w", newline="") as f:
                writer = csv.writer(f)
                # Write the header row
                writer.writerow(["Student ID", "Roll No", "Name", "Date"])

        with open("attendance_report/Student_attendance_list.csv","r+", newline="\n") as f:
